...
public class SampleInputTest extends BaseTest {
    ...
    public void testDepend() throws IOException, SfRuntimeException {
        String[] input = {
                "DEPEND A B\n",
                "END\n"
        };
    ...
    public void testInstall() throws IOException, SfRuntimeException {
        String[] input = {
                "DEPEND A B\n",
                "INSTALL B\n",
                "END\n"
    ...
    public void testRemove() throws IOException, SfRuntimeException {
        String[] input = {
                "DEPEND A B\n",
                "INSTALL B\n",
                "INSTALL A\n",
    ...
    public void testList() throws IOException, SfRuntimeException {
    ...
    @Test
    public void testSampleInput() throws IOException, SfRuntimeException {
        String[] input = {
